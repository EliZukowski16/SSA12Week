...
public class T9Trie implements Text9Trie
{
    ...
    private void buildT9Map()
    {
        ...
        t9Map.put("2", new char[] {'a','b','c'});
        t9Map.put("3", new char[] {'d','e','f'});
        t9Map.put("4", new char[] {'g','h','i'});
        t9Map.put("5", new char[] {'j','k','l'});
        t9Map.put("6", new char[] {'m','n','o'});
        t9Map.put("7", new char[] {'p','q','r','s'});
        t9Map.put("8", new char[] {'t','u','v'});
        t9Map.put("9", new char[] {'w','x','y','z'});
    }
